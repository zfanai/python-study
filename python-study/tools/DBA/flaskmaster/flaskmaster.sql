...
/*
DROP TABLE IF EXISTS fm_user_01;
CREATE TABLE fm_user_01 (
...
desc fm_user_01;
*/
-- alter table fm_user add column updated datetime not null;
-- desc fm_user;
 select * from fm_user order by updated desc limit 5;
-- select * from fm_user_01;
